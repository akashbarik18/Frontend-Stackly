  ...
  absolute bottom-[320px]">
    ...
    max-[440px]:font-semibold"
        ...
        max-[440px]:font-['Inter']"
            ...
            <Link to="/sign-up" className=" w-full max-w-[435px] min-h-[55px] rounded-[12px] border cursor-pointer font-medium text-base text-white bg-[#0000004d] mt-[50px] pt-[10px] pr-[20px] pb-[10px] pl-[20px]  border-solid border-[white] flex justify-center items-center gap-[10px]">
          ...
          <div className="max-[1000px]:w-full max-w-[529px] min-h-[608px] flex flex-col gap-10 items-center justify-center bg-[#0000004d] pt-[28px] pr-[32px] pb-[28px] pl-[32px] rounded-[10px]
