...
>
<div
  className="w-[586px] h-[78px] text-[32px] leading-[100%] text-center text-[#007B82] mb-[-49px]
             max-[440px]:w-[271px] 
             max-[440px]:h-[50px] 
             max-[440px]:text-[18px] 
...
/>
  ...
  <div className="w-[140px] max-w-[140px] min-h-[140px] rounded-[50%] font-bold text-[52px] leading-[60px] text-black shadow-[0_3px_20px_0px] shadow-black flex flex-col justify-center items-center relative top-[-350px] left-[315px] bg-white">
<div className="w-[140px] h-[140px] rounded-full bg-white shadow-[0_3px_20px_0px] shadow-black flex flex-col items-center justify-center">
  <div
...
/>
 ...
 <div
  className="w-[77px] h-[51px] text-[42px] font-semibold leading-[100%] text-right text-[#007B82] opacity-100 absolute"
  style={{ fontFamily: "Inter", top: "36px", left: "32px" }}
>
  85+
</div>
     ...
     <div
  className="w-[55px] h-[19px] text-[16px] font-normal leading-[100%] text-right text-[#007B82] opacity-100 absolute"
  style={{ fontFamily: "Inter", top: "85px", left: "31px" }}
>
  Images
</div>
