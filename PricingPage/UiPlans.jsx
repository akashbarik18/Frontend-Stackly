...
>
      ...
      <div className="flex flex-col gap-4">
        ...
        <Link to="/Sign-in">
         <div className="w-full py-3 rounded-lg text-white flex justify-center items-center bg-[linear-gradient(180deg,_#007B82_0%,_#00B0BA_100%)] hover:opacity-90">
  Get Started
</div>
...
<div className="hidden max-[440px]:block w-[168px] h-[168px] bg-[#00B0BA66] mx-auto mb-6 rounded-full blur-[124px]"></div>
     ...
     <div className="max-w-6xl mx-auto flex flex-col items-center gap-12 max-[440px]:-mt-[185px]">
        ...
        <div className="text-center">
          <h2 className="text-white text-3xl md:text-4xl font-medium mb-4 max-[440px]:w-[400px] max-[440px]:h-[24px] max-[440px]:text-[20px] max-[440px]:leading-[100%] max-[440px]:text-center" style={{ fontFamily: 'Aptos Serif' }}>
            Find the right plan that suits your needs
          </h2>
