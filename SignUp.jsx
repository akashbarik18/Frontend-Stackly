...
export default function SignUp({ setUser }) {
  ...
  max-[440px]:text-center">
            ...
            <h1 className="text-[60px] sm:text-[72px] font-bold leading-[100%] text-center text-[#009A98] min-h-[87px]
  max-[440px]:w-[227px]
  max-[440px]:h-[45px]
  ...
  max-[440px]:gap-[32px]"
    ...
    max-[440px]:rounded-[8px]"
              ...
              <div
                className="max-w-[458px] w-full bg-white flex items-center justify-center p-[15px] rounded-[5px]
    max-[440px]:w-[360px]
    max-[440px]:h-[44px]
    max-[440px]:rounded-[8px]"
              >
