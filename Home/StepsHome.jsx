...
export default function StepsHome() {
  return (
  <section
  className="w-full h-[777px] bg-black opacity-100 pt-[60px] pb-[60px] gap-[53px]"
>
    ...
    <div className="w-full h-[657px] opacity-100 gap-[65px] flex flex-col items-center mx-auto">
        ...
        <div className="w-[1120px] h-[81px] opacity-100 gap-[18px] text-center flex flex-col justify-center items-center">
          ...
          >
            Bringing <span className="text-[#8A38F5] lora-text"> Beauty </span>
            to Every Corner
          </h1>
  ...
  {[
    ...
    <SlideInView key={index} delay={index * 0.3}>
     <div className="flex flex-col w-[400px] h-[470px] rounded-[12px] opacity-100 relative">
        ...
        {/* Step Badge */}
<div
  className="absolute top-[394px] left-[250px] flex items-center gap-[10px] 
             rounded-[12px] px-[22px] py-[10px] 
             backdrop-blur-[6px] shadow-[0px_2px_6px_0px_#00000040] 
             border border-white/20 bg-white/10"
>
 <div className="w-[19.5px] h-[19.5px] border-[1.5px] border-white opacity-100 overflow-hidden flex items-center justify-center rounded-full">
  ...
  {item.step}
        ...
        {/* Image block */}
     <div
  className="w-[400px] h-[470px] rounded-[12px] bg-cover bg-center bg-no-repeat opacity-100"
  style={{
    backgroundImage: `linear-gradient(180deg, #00000066 0%, #00000066 100%), url('${item.image}')`
  }}
></div>
 ...
 {/* Text block */}
        <div className="absolute top-[47px] left-[25px] w-[247px] h-auto text-white">
