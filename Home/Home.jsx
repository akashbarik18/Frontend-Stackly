...
{/* new figma disgine sec2 */}
  <section className="w-full h-[857px] rotate-0 opacity-100 bg-[#000000] relative overflow-hidden">
      ...
      <img
        src={DotFrame}
        alt="Dot Frame"
        className="w-[818px] h-[163px] opacity-100 rotate-0 absolute top-[62px] left-[-367px]"
      />
...
>
  ...
  max-[440px]:w-[89px] max-[440px]:h-auto">
    ...
    max-[440px]:leading-[140%] max-[440px]:text-center flex items-center justify-center"
      ...
      {/* new figma section6 */}
      <section
  className="w-full h-[713px] bg-[#000000] opacity-100 relative"
>
...
>
  ...
  {/* Bottom Section */}
  <div
    className="w-[424px] h-[199px] rounded-[20px] border border-solid opacity-100"
    style={{
      background: "#8A38F514",
      borderImage: "linear-gradient(283.03deg, #8A38F5 -4.05%, #000000 106.3%) 1",
    }}
  >
    <div
      className="w-[412px] h-[186px] rounded-[20px] flex flex-col gap-[18px] pt-[24px] pr-[16px] pb-[24px] pl-[20px] opacity-100"
      style={{
        background: "#8A38F514",
      }}
    >
                ...
                <div className="w-[245px] h-[44px] flex items-center justify-start opacity-100">
                   <Link to="/sign-in">
                  <div
                  ...
                  >
                    ...
                    {/* Icon container */}
                    <div className="w-[24px] h-[24px] opacity-100 p-[2.25px] box-border">
                      <img
                        src={Frame}
                        alt="icon"
...
{/*         
      ...
      <FAQ faqs={faqs} />
<section className="relative w-full max-w-full h-[316px] opacity-100 mx-auto bg-black">
