...
import Bg from "../../assets/home/Uplod.png"
...
export default function BasicForm() {
 ...
 <section
  className="
    w-full h-[580px] px-[40px] py-[80px] bg-top bg-cover bg-no-repeat 
    flex flex-col justify-center items-center 
    opacity-100

    max-[440px]:h-[649px] max-[440px]:w-[440px] max-[440px]:py-[24px]  
    max-[440px]:bg-[length:100%_100%] max-[440px]:bg-no-repeat max-[440px]:bg-top max-[440px]:justify-between
  ...
  "
  style={{
    backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 0.4), rgba(0, 0, 0, 0.4)), url(${Bg})`,
