 ...
 <div className="flex items-center justify-center relative max-[440px]:gap-[20px]">
  ...
  <div className="flex gap-[6.39px] mx-[15px]">
    <span
      onClick={() => setIndex(0)}
      className={`${
        index === 0 ? "w-[33.01px]" : "w-[6.39px]"
      } h-[6.39px] rounded-full cursor-pointer ${
        index === 0 ? "bg-cyan-500" : "bg-black"
      }`}
    />
    <span
      onClick={() => setIndex(1)}
      className={`${
        index === 1 ? "w-[33.01px]" : "w-[6.39px]"
      } h-[6.39px] rounded-full cursor-pointer ${
        index === 1 ? "bg-cyan-500" : "bg-black"
      }`}
    />
    <span
      onClick={() => setIndex(2)}
      className={`${
        index === 2 ? "w-[33.01px]" : "w-[6.39px]"
      } h-[6.39px] rounded-full cursor-pointer ${
        index === 2 ? "bg-cyan-500" : "bg-black"
      }`}
    />
  </div>
