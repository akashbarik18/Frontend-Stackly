...
>
  ...
  <span className="text-[#00B0BA]">
    Get Instant API Access for your AI Design Platform
        ...
        <Link to="/Sign-in">
          {" "}
         <button className="w-[306px] h-[45px] mt-8 rounded-[6px] border-[1px] border-solid border-transparent 
...
>
  ...
  alt="API Background"
  className="absolute w-[1150.91px] h-[848px] p-[34px] opacity-60
             min-[412px]:w-[440px] min-[412px]:h-[273px] min-[412px]:opacity-40"
/>


        {/* Text Content */}
<div
  className="relative z-10 w-[1172px] h-[242px] flex flex-col items-center justify-center text-black text-center -mt-40
             max-[440px]:w-[400px] max-[440px]:h-[193px] max-[440px]:flex-col max-[440px]:gap-[32px] 
             max-[440px]:mt-[35px]"
>
...
>
  ...
  Let’s build the right setup—just for you.
          ...
          <Link to="/Sign-in">
            ...
            {/* DESKTOP */}
            <button
              className="w-[800px] h-[70px] mt-[80px] rounded-[6px] border border-transparent 
             bg-gradient-to-l from-[#00B0BA] via-[#000000] to-[#007B82] text-white 
             font-semibold text-[18px] leading-[100%] 
             max-[440px]:hidden"
            >
              Let’s Connect!
            </button>
