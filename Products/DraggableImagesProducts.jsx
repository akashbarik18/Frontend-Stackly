  ...
  const RoomCard = ({ roomName, originalImage, transformedImage, roomKey }) => (
    <div className="max-w-[522px] m-auto w-full h-auto sm:min-h-auto flex flex-col gap-2 max-[440px]:w-[188px] max-[440px]:h-[188.02px] max-[440px]:gap-[7.51px]">
       <div className="max-w-[520px] min-h-[35px] flex justify-between max-[440px]:w-[188px] max-[440px]:h-[20px] max-[440px]:justify-between">
          <div class Name="text-[24px] font-semibold leading-[35px] spacing-[8px] text-center text-[#2A2A2A] max-[440px]:w-[81px] max-[440px]:h-[13px] max-[440px]:font-[400] max-[440px]:text-[14px] max-[440px]:leading-[12.23px] max-[440px]:tracking-[0] max-[440px]:text-center">
          {roomName}
        </div>
       <div
...
<img
  src={Banner}
  alt="banner1"
  className="absolute left-[-60px] top-[30px] max-[440px]:hidden"
/>

    <img src={Banner1} alt="banner2" className="max-[440px]:hidden" />
<img src={Banner1} alt="banner2" className="max-[440px]:hidden" />
